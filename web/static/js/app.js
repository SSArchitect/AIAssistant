...
const I18N = {
    zh: {
        ...
        pulse: {
            ...
            emptyUnavailableDetail: '本轮没有找到由至少两个独立来源共同证实、且至少一个来源在近 30 天内的具体事件，因此不展示卡片。',
    ...
    en: {
        ...
        pulse: {
            ...
            emptyUnavailableDetail: 'No concrete event was confirmed by two independent sources with at least one source from the last 30 days, so no cards are shown.',
