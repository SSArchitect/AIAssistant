...
func TestAdminDeleteAccountPurgesRelatedDataAndProtectsDefault(t *testing.T) {
	...
	records := []interface{}{
		...
		&models.FocusTodaySnapshot{ID: "delete-focus-today", UserID: accountID, Date: "2026-08-24", Title: "Focus Today", Prompt: "private", Content: "private", CreatedAt: now, UpdatedAt: now},
		...
		&models.PulseRetrievalRun{ID: "delete-pulse-run", UserID: accountID, Date: "2026-08-24", QueryCount: 1, CreatedAt: now},
