...
func main() {
	...
	api := r.Group("/api")
	{
		...
		api.GET("/projects", knowledgeHandler.List)
		api.POST("/projects", knowledgeHandler.Create)
		api.PUT("/projects/order", knowledgeHandler.Reorder)
		api.POST("/projects/from-selection", knowledgeHandler.CreateFromSelection)
		api.GET("/projects/:id", knowledgeHandler.Get)
		api.PUT("/projects/:id", knowledgeHandler.Update)
		api.DELETE("/projects/:id", knowledgeHandler.Delete)
		api.POST("/projects/:id/documents", knowledgeHandler.CreateDocument)
		api.DELETE("/projects/:id/documents/:document_id", knowledgeHandler.DeleteDocument)
		api.GET("/projects/:id/search", knowledgeHandler.Search)
		api.POST("/projects/:id/context", knowledgeHandler.Context)
