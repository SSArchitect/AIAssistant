        ...
        AgentInfo(
            ...
            metadata={
                ...
                "command_protocol": {
                    ...
                    "usage": "/agent deep_research_v1 /plan <研究问题>；确认后回复 /start 或“开始研究”。",
                    "commands": [
                        "/plan <研究问题>",
                        "/start",
                        "/execute",
                ...
                "quick_actions": [
                    {
                        "id": "plan",
                        "label": {"zh": "研究计划", "en": "Plan"},
                        "description": {"zh": "先生成可确认的研究大纲", "en": "Create a confirmable research outline first"},
                        "query": "/plan ",
                    },
                    {
                        "id": "start",
                        "label": {"zh": "开始研究", "en": "Start"},
                        "description": {"zh": "确认上一份研究计划并执行", "en": "Approve the latest research plan and execute it"},
                        "query": "/start",
                        "auto_send": True,
                    },
                    {
                        "id": "help",
                        "label": {"zh": "流程说明", "en": "Flow"},
                        "description": {"zh": "查看深度研究的两阶段流程", "en": "Show the two-stage deep research flow"},
                        "query": "/help",
                        "auto_send": True,
                    },
                ],
