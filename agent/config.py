...
class RuntimeConfig:
    ...
    def __init__(self):
        ...
        self._data = {
            ...
            "search.rewrite.enabled": str(_search_broad_cfg.get("rewrite_enabled", True)).lower(),
            "search.rewrite.provider": str(_search_broad_cfg.get("rewrite_provider", "")),
            "search.rewrite.max_queries": str(_search_broad_cfg.get("rewrite_max_queries", 4)),
            "search.rewrite.timeout_seconds": str(_search_broad_cfg.get("rewrite_timeout_seconds", 12)),
