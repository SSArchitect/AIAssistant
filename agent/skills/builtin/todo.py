...
class TodoCreateSkill(_TodoTool):
    ...
    def metadata(self) -> SkillMetadata:
        return SkillMetadata(
            ...
            source="builtin",
            domains=["todo"],
            routing_keywords=["创建待办", "提醒我", "记一下", "加入待办"],
        ...
        return SkillMetadata(
            ...
            parameters=[
                SkillParameter(
                    ...
                    required=False,
                    default="today",
                    enum=["today", "overdue", "inbox", "month", "upcoming", "done"],
                ),
            ...
            source="builtin",
            domains=["todo"],
            routing_keywords=["今日待办", "待办列表", "本月任务", "过期待办"],
            allowed_agents=["super_chat"],
            parallel_safe=True,
            idempotent=True,
            max_calls_per_run=12,
        ...
        return SkillMetadata(
            ...
            parameters=[
                ...
                SkillParameter(
                    name="repeat_rule",
                    type="string",
                    description="once、daily 或 workdays。",
                    required=False,
                    enum=["once", "daily", "workdays"],
                ),
                SkillParameter(
                ...
                SkillParameter(
                    name="status",
                    type="string",
                    description="open 或 done。完成待办传 done，取消完成传 open。",
                    required=False,
                    enum=["open", "done"],
                ),
            ],
            ...
            source="builtin",
            domains=["todo"],
            routing_keywords=["更新待办", "完成待办", "修改任务", "取消完成"],
            allowed_agents=["super_chat"],
            risk_level="medium",
            access="write",
            max_calls_per_run=8,
